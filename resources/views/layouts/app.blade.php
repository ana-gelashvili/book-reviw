...
<head>
  ...
  <style type="text/tailwindcss">
    .btn {
      @apply bg-white rounded-md px-4 py-2 text-center font-medium text-slate-500 shadow-sm ring-1 ring-slate-700/10 hover:bg-slate-50;
    }
    ...
    .book-item {
      @apply rounded-md bg-white p-4 leading-none ring-1 ring-slate-900/5 shadow-sm;
    }

    .empty-book-item {
      @apply rounded-md bg-white py-10 px-4 text-center leading-none ring-1 ring-slate-900/5 shadow-sm;
    }
    ...
    .empty-text {
      @apply text-lg font-semibold text-slate-500;
    }
